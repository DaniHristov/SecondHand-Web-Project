...
namespace SecondHandClothes.Data.Migrations
{
    ...
    [Migration("20210803150805_Introduced-Order-Table")]
    partial class IntroducedOrderTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SecondHandClothes.Services.Products.ProductServiceModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("ProductServiceModel");

                    b.HasDiscriminator<string>("Discriminator").HasValue("ProductServiceModel");
                });

            modelBuilder.Entity("SecondHandClothes.Services.Products.Models.ProductDetailsServiceModel", b =>
                {
                    b.HasBaseType("SecondHandClothes.Services.Products.ProductServiceModel");
                    ...
                    b.HasDiscriminator().HasValue("ProductDetailsServiceModel");
                });
